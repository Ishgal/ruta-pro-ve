...
export default function AdminSidebar() {
  ...
  return (
    <aside className="hidden md:flex flex-col w-44 shrink-0 bg-white border-r border-gray-100 min-h-screen px-3 py-6">
      <div className="mb-8 px-2">
        <span className="text-[#00B5B5] font-black text-xl tracking-tight">RUTA PRO</span>
        <p className="text-[10px] font-semibold text-gray-400 tracking-widest uppercase mt-0.5 px-0.5">Admin</p>
      </div>
